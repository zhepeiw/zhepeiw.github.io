...
date: '2019-08-03'
updatedDate: 2019-08-03T00:00:00.000Z
tags:
  - Dev tools
---
...
To begin with, the [Vim official site](https://www.vim.org/download.php) provides a few different ways to download and install Vim on your machine. The recommended way is to compile from source:
```bash
...
## Functionality
### Code Folding
Current text editors provide the ability to collapse a block of code to make it easier to browse through the entire file. [SimplyFold](https://github.com/tmhedberg/SimpylFold) is an extension that enables code folding and expansion in Vim. To install, add the following to `.vimrc`:
...
### Commenter
[NERD Commenter](https://github.com/scrooloose/nerdcommenter) is a powerful tool to comment/uncomment your code. To install, add 
```vim
...
[auto-pairs](https://github.com/jiangmiao/auto-pairs) is a tool that may autocomplete pairs of parentheses, brackets, etc under insertion or deletion. Add the following to `.vimrc`:
...
### Auto-complete
[TabNine](https://tabnine.com/) is an awesome tool for autocompletion and it is based on [YouCompleteMe](https://github.com/ycm-core/YouCompleteMe), another powerful tool. I would recommend TabNine mainly because it's easier than YouCompleteMe to install and configure, and a deep-learning based version for TabNine would come out soon (so that it automatically writes code for you!). To install, simply add to `.vimrc`
```vim
Plugin 'zxqfl/tabnine-vim'
```

### File Tree
[NERDTree](https://github.com/scrooloose/nerdtree) is a plugin for file system explorer for Vim. Add to your `.vimrc`
...
### Script Header
[vim-header](https://github.com/alpertuna/vim-header) is a tool that helps us easily add author and license information to the scripts. Add 
```vim
...
## Appearance
### Color Theme
I personally prefer [gruvbox](https://github.com/morhetz/gruvbox) as the primary color scheme. To install, add to `.vimrc`
```vim
...
### Status Line
[vim-airline](https://github.com/vim-airline/vim-airline-themes) is an extension to enhance the appearance of the status bar. To install, add to `.vimrc`
